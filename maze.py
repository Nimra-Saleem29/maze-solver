...
# --- MAIN EXECUTION BLOCK (Works in Mu Editor) ---

filename = "maze.txt"  # Change if your file name is different
maze = Maze(filename)
...
print("Solution:")
maze.print_maze()
maze.output_image("maze.png", show_solution=True,show_explored=True)
